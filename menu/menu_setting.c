      ...
      const char *parent_group)
{
   ...
   switch (type)
   {
      case SETTINGS_LIST_MAIN_MENU:
         ...
         CONFIG_ACTION(
            list, list_info,
            MENU_ENUM_LABEL_KAILLERA,
            MENU_ENUM_LABEL_VALUE_KAILLERA,
            &group_info,
            &subgroup_info,
            parent_group);
         MENU_SETTINGS_LIST_CURRENT_ADD_CMD(list, list_info, CMD_EVENT_KAILLERA);
    ...
    (defined(HAVE_COCOA_METAL) && !defined(HAVE_COCOATOUCH))
      ...
      case SETTINGS_LIST_MENU:
         ...
         if (string_is_equal(settings->arrays.menu_driver, "ozone"))
         {
            ...
            CONFIG_BOOL(
               list, list_info,
               &settings->bools.menu_show_kaillera,
               MENU_ENUM_LABEL_MENU_SHOW_KAILLERA,
               MENU_ENUM_LABEL_VALUE_MENU_SHOW_KAILLERA,
               DEFAULT_MENU_SHOW_KAILLERA,
               MENU_ENUM_LABEL_VALUE_OFF,
               MENU_ENUM_LABEL_VALUE_ON,
               &group_info,
               &subgroup_info,
