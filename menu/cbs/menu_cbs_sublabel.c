...
#endif
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_kaillera,                      MENU_ENUM_SUBLABEL_KAILLERA)
...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_menu_show_kaillera,                    MENU_ENUM_SUBLABEL_MENU_SHOW_KAILLERA)
#ifndef HAVE_LAKKA
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_MENU_SHOW_RESTART_RETROARCH:
            ...
            break;
#endif
         case MENU_ENUM_LABEL_MENU_SHOW_KAILLERA:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_menu_show_kaillera);
            break;
        ...
        case MENU_ENUM_LABEL_PLAY_REPLAY:
         ...
         case MENU_ENUM_LABEL_QUIT_RETROARCH:
            ...
            break;
         case MENU_ENUM_LABEL_KAILLERA:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_kaillera);
            break;
