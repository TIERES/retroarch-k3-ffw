...
enum
{
   ...
   OZONE_ENTRIES_ICONS_TEXTURE_KAILLERA,
      ...
      bool active)
{
   switch (enum_idx)
   {
      ...
      case MENU_ENUM_LABEL_KAILLERA:
         return ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_KAILLERA];
...
static const char *ozone_entries_icon_texture_path(unsigned id)
{
   switch (id)
   {
      ...
      case OZONE_ENTRIES_ICONS_TEXTURE_KAILLERA:
      ...
      case DISPLAYLIST_MAIN_MENU:
         {
            ...
            if (settings->bools.menu_show_kaillera)
            {
