      ...
      settings_t *settings, int *size)
{
   ...
   SETTING_BOOL("quick_menu_show_kaillera",                   &settings->bools.quick_menu_show_kaillera, true, DEFAULT_QUICK_MENU_SHOW_KAILLERA, false);
   ...
   SETTING_BOOL("menu_show_kaillera",            &settings->bools.menu_show_kaillera, true, DEFAULT_MENU_SHOW_KAILLERA, false);
